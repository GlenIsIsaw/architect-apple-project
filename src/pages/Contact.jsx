          ...
          <Col lg={5} className="contact-info">
            ...
            >
              ...
              <div className="info-item">
                ...
                <p>123 Design Street, Creative District<br />
                Your City, ST 10001</p>
              </div>
              
              <div className="info-item">
                <h4>Email</h4>
                <p><a href="mailto:studio@yourarchitecture.com">studio@yourarchitecture.com</a></p>
              </div>
                ...
                <Row className="g-3">
                  <Col md={6}>
                    <Form.Group controlId="formName">
                      ...
                      <Form.Control type="text" placeholder="e.g. Sarah Johnson" />
                    </Form.Group>
                  </Col>
                  <Col md={6}>
                    <Form.Group controlId="formEmail">
                      <Form.Label>Email Address</Form.Label>
                      <Form.Control type="email" placeholder="e.g. sarah@example.com" />
                    </Form.Group>
                  </Col>
                  <Col md={12}>
